...
public class SimpleAspect {
    ...
    @Pointcut(value = "execution(* com.hundsun.demo.springboot.spring.aop.service.impl.AopServiceImpl.*(..)) || execution(* com.hundsun.demo.springboot.spring.aop.service.impl.AopServiceWithOutInterface.*(..))")
    public void point() {
    }
