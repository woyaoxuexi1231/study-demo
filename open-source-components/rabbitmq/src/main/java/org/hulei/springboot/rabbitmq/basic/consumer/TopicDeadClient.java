            ...
            channel.basicConsume(
                    ...
                    new DefaultConsumer(channel) {
                        ...
                        public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) {
                            ...
                            System.out.printf("收到消息: %s, 主题: %s%n", new String(body, StandardCharsets.UTF_8), envelope.getRoutingKey());
                            /*
            ...
            deadChannel.basicConsume(
                    ...
                    new DefaultConsumer(channel) {
                        ...
                        public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                            System.out.printf("死信队列收到消息: %s%n", new String(body, StandardCharsets.UTF_8));
                            deadChannel.basicAck(envelope.getDeliveryTag(), false);
                        }
                    }
            );
        } catch (Exception e) {
            System.out.printf("接受消息异常. error: %s%n", e.getMessage());
        }
    }
}
