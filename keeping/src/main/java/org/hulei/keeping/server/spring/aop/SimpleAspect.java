...
public class SimpleAspect {
    ...
    @Pointcut(value = "execution(* org.hulei.keeping.server.spring.aop.service.impl.AopServiceImpl.*(..)) || execution(* org.hulei.keeping.server.spring.aop.service.impl.AopServiceWithOutInterface.*(..))")
    public void point() {
    }
