package com.hundsun.demo.java.db.mysql;

/**
 * @projectName: study-demo
 * @package: com.hundsun.demo.java.db.mysql
 * @className: MysqlInstallNote
 * @description:
 * @author: h1123
 * @createDate: 2023/11/7 10:58
 */

public class MysqlInstallNote {
    /*
    my.cnf 文件随便找一个就行
    主要修改
    [mysqld]
...
2023-11-07T02:53:32.292578Z mysqld_safe error: log-error set to '/var/log/mariadb/mariadb.log', however file don't exists. Create writable for user 'mysql'.
