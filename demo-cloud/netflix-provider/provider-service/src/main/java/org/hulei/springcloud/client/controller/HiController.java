...
@RestController
@Slf4j
public class HiController implements HiControllerFeign {
    ...
    @SneakyThrows
    @Override
    public String hiWithRequestParam(String param, HttpServletRequest req, HttpServletResponse rsp) {
        /*
    ...
    @SneakyThrows
    @Override
    public String hiWithPathParam(String param, HttpServletRequest req, HttpServletResponse rsp) {
        /*
    ...
    @SneakyThrows
    @Override
    public String hiBody(SimpleReqDTO reqDTO, HttpServletRequest req, HttpServletResponse rsp) {
        /*
    ...
    @SneakyThrows
    @Override
    public Map<String, Object> change(Map<String, Object> map, HttpServletRequest req, HttpServletResponse rsp) {
        /*
